                    ...
                    Object.keys(chartData).map((key) => {
                      ...
                      return (
                        <tr key={key} className='text-center w-fit even:bg-blue_green/30'>
                          <td className='relative stack text-black text-lg'>
                            ...
                            <MdPerson/>
                            <span className="absolute indicator-item bottom-0 right-0 translate-x-1/2 -translate-y-1/2 status status-success w-2 h-2 "/>
                          </td>
                          <td>{item.emp_name}</td>
                          <td>{item.emp_id}</td>
