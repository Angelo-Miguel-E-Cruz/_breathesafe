  ...
  return (
    <div className={clsx("card card-border border-lightblack bg-skyblue w-full shadow-black/50 shadow-md", { 'mb-8': type === "aqi" })}>
      <div className='card-body gap-0'>
        <h1 className='w-full h-full font-bold self-center text-[23px] bg-blue_green text-center text-white'>{title}</h1>
        <div className="h-85 overflow-x-auto w-full p-5 pt-0">
